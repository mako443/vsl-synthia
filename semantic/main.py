...
if __name__=='__main__':
    ...
    if 'create-semantic' in sys.argv:
        for base_dir in ('data/SYNTHIA-SEQS-04-SUMMER/selection/', 'data/SYNTHIA-SEQS-04-DAWN/selection/', 'data/SYNTHIA-SEQS-04-WINTER/selection/'):
